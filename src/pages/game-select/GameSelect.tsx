    ...
    <main>
      <section className="grid grid-cols-2 items-start mx-auto relative overflow-hidden ">
        <div className="w-full">
          <h2 className="text-textColorPrimary font-bold text-6xl mb-10">Welcome to Game Project</h2>
      ...
      <section className="mt-10">
        <h2 className="text-textColorPrimary font-bold text-5xl mb-10">Games:</h2>
        ...
        <div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="flex flex-col items-center justify-center bg-backgroundColorSecondary rounded-lg p-6">
                ...
                <button className="w-40 my-5 p-2 bg-buttonColor shadow-lg shadow-hoverColorButton/50 hover:shadow-hoverColorButton/40 text-textColorPrimary font-semibold rounded-lg" onClick={() => selectGame('jogo_da_velha')}>Select</button>
            </div>
            ...
            <div className="flex flex-col items-center justify-center bg-backgroundColorSecondary rounded-lg p-6">
              ...
              <p className="text-textColorPrimary text-lg text-center">Descrição do item aqui</p>
              <button className="w-40 my-5 p-2 bg-buttonColor shadow-lg shadow-hoverColorButton/50 hover:shadow-hoverColorButton/40 text-textColorPrimary font-semibold rounded-lg" onClick={() => selectGame('response_select')}>Select</button>
            </div>
            ...
            <div className="flex flex-col items-center justify-center bg-backgroundColorSecondary rounded-lg p-6">
              <h3 className='mb-5 hover:text-textColorPrimary text-textHintColor font-semibold rounded-lg text-xl'>Aimshot Response</h3>
                ...
                <p className="text-textColorPrimary text-lg text-center">Descrição do item aqui</p>
                <button className="w-40 my-5 p-2 bg-buttonColor shadow-lg shadow-hoverColorButton/50 hover:shadow-hoverColorButton/40 text-textColorPrimary font-semibold rounded-lg" onClick={() => selectGame('aimshot_response')}>Select</button>
            </div>
          </div>
        </div>
      </section>
