          ...
          <div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="flex flex-col items-center justify-center bg-backgroundColorSecondary rounded-lg p-6">
                  ...
                  <p className="text-gray-800 text-lg text-center">Crie, edite ou remova suas disciplinas e visualize todas as disciplinas contida no ambiente colaborativo.</p>
              ...
              <div className="flex flex-col items-center justify-center bg-backgroundColorSecondary rounded-lg p-6">
                ...
                <p className="text-gray-800 text-lg text-center">Crie, edite ou remova suas atividades e visualize todas as atividades contida no ambiente colaborativo.</p>
              ...
              <div className="flex flex-col items-center justify-center bg-backgroundColorSecondary rounded-lg p-6">
                <h3 className='mb-5 hover:text-white text-gray-400 font-semibold rounded-lg text-xl'>Games</h3>
                  ...
                  <p className="text-gray-800 text-lg text-center">Jogue jogos e tenha a experiência de aprendizado dos estudantes no ambiente colaborativo.</p>
