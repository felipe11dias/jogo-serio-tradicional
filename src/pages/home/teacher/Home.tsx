          ...
          <div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="flex flex-col items-center justify-center bg-backgroundColorSecondary rounded-lg p-6">
                  <h3 className='mb-5 hover:text-textColorPrimary text-textHintColor font-semibold rounded-lg text-xl'>Disciplinas</h3>
                  <img className='w-80 h-80 object-cover rounded-lg' src={disciplineImg} alt="Image Disciplines" />
                  <p className="text-textColorPrimary text-lg text-center">Crie, edite ou remova suas disciplinas e visualize todas as disciplinas contida no ambiente colaborativo.</p>
              ...
              <div className="flex flex-col items-center justify-center bg-backgroundColorSecondary rounded-lg p-6">
                <h3 className='mb-5 hover:text-textColorPrimary text-textHintColor font-semibold rounded-lg text-xl'>Atividades</h3>
                <img className='w-80 h-80 object-cover rounded-lg' src={activityImg} alt="Image Activities" />
                <p className="text-textColorPrimary text-lg text-center">Crie, edite ou remova suas atividades e visualize todas as atividades contida no ambiente colaborativo.</p>
              ...
              <div className="flex flex-col items-center justify-center bg-backgroundColorSecondary rounded-lg p-6">
                <h3 className='mb-5 hover:text-textColorPrimary text-textHintColor font-semibold rounded-lg text-xl'>Jogos</h3>
                  <img className='w-80 h-80 object-cover rounded-lg' src={gamesImg} alt="Image Games" />
                  <p className="text-textColorPrimary text-lg text-center">Jogue jogos e tenha a experiência de aprendizado dos estudantes no ambiente colaborativo.</p>
