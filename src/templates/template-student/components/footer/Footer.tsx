...
const Footer = () => {
  return <footer className='flex sm:flex-col md:flex-row  lg:flex-row xl:flex-row justify-between items-center py-6 bg-backgroundColorPrimary'>
    ...
    <p className="w-full  text-gray-400 font-semibold rounded-lg text-xl">© Copyright 2023 - Todos os direitos reservados para - TCC Felipe</p>
    </div>
    <div className='flex flex-row mx-2 '>
           <div className=' rounded-full py-2 px-2 transition duration-300 ease-in-out hover:scale-125 hover:bg-gray-800 hover:cursor-pointer'>
